...
# zoxide
alias ~="z ~"
alias hamo="z ~/workspace/discord/hamohasi-bot"
...
alias updateopenwebui="docker run --rm --volume /var/run/docker.sock:/var/run/docker.sock containrrr/watchtower --run-once open-webui"
